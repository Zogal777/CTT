// Koda piemēru saraksts ir paņemts un pielāgots no
// Chalarangelo/30-seconds-of-code (CC-BY-4.0):
// https://github.com/Chalarangelo/30-seconds-of-code

// Te glabājas spēles galvenais stāvoklis:
// pašreizējais kods, lietotāja ievade, statistika un iestatījumi.
let currentCode = "";
let typedText = "";
let codeParts = [];
...
// Koda piemēri ir sadalīti pēc grūtības līmeņiem.
// Viens piemērs = viens typing uzdevums.
...
// Aizliedz pārlūka standarta rediģēšanas darbības,
// lai rakstīšanas laukumu kontrolētu tikai mūsu kods.
...
// Parāda tikai tos ievades laukus, kas vajadzīgi izvēlētajam spēles režīmam.
...
// Atiestata iepriekšējo sesiju, pārbauda ievadītos datus
// un palaiž jaunu spēli.
function startGame(){
...
// Izveido sajauktu koda piemēru sarakstu konkrētajai spēles sesijai.
...
// Ielādē nākamo koda piemēru.
// Ja visi piemēri izieti, tiek izveidots jauns saraksts.
...
// Attēlo katru simbolu ar atbilstošu stāvokli:
// pareizs, nepareizs vai vēl neuzrakstīts.
...
// Pārrēķina redzamo statistiku:
// laiku, WPM, kļūdas un pabeigto piemēru skaitu.
...
// Beidz spēli, saglabā rezultātu un parāda paziņojumu par sesijas beigām.
...
codeArea.addEventListener("keydown", (event) => {
    ...
    // Salīdzina nospiesto taustiņu ar simbolu,
    // kuram šajā pozīcijā bija jābūt.
...
// Saskaita tikai tos simbolus, kas sakrīt tieši pareizi.
// To izmanto WPM aprēķinam.
...
// lai katrā jaunā spēlē piemēru kārtība atšķirtos.
...
// Saglabā tikai 10 jaunākos rezultātus pārlūka localStorage.
function saveResult(){
...
// Uzzīmē saglabāto rezultātu sarakstu zem spēles laukuma.
...
// Pārveido iekšējos režīmu nosaukumus uz cilvēkam saprotamu tekstu.
...
// Pārveido sekundes formātā MM:SS.
...
// Universāls paziņojuma logs brīdinājumiem un spēles beigu ziņām.
...
// Aizvieto speciālos simbolus, lai kods droši parādītos HTML skatā.
